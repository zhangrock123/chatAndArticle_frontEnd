<template>
    <div id="app-container" class="requestHistory-page" v-height-ctrl="">
       <header id="app-header">
            <page-header :page-title="'发送的好友请求'" :page-left="pageLeft"></page-header>
        </header> 
        <section id="app-body">
    ...
    export default {
        ...
        methods: {
            getSentRequestList(isLoadMore){
                ...
                return vm.$root.service('sentHistory', param, function(res){
            ...
            loadMoreList(){
                this.page++;
                return this.getSentRequestList(true);
            },
        },
        events:{
